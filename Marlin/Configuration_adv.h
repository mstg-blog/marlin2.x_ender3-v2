...
// LCD Print Progress options
  ...
  #define POWER_LOSS_RECOVERY
    ...
    #define PLR_ENABLED_DEFAULT   ture  //Tip:After changing to true, you need to enable enable power loss recovery under the "control" page on the UI interface
                                        // Power Loss Recovery enabled by default. (Set with 'M413 Sn' & M500)
